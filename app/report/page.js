              ...
              <div className="space-y-4">
                <div>
                  <label className="flex items-center text-white text-sm font-medium mb-1">
                    <FaExclamationTriangle className="text-red-400 mr-2" /> Report Type
                  </label>
                  <select
                    name="reportType"
          ...
          <>
            <div className="mb-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="flex items-center text-white text-sm font-medium mb-1">
                    <FaRegUser className="text-yellow-400 mr-2" /> Suspect Description
                  </label>
                  <textarea
      ...
      case 3:
        return (
          <>
            <div className="mb-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold text-white">Evidence & Submission</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="flex items-center text-white text-sm font-medium mb-1">
                    <FaInfoCircle className="text-blue-400 mr-2" /> Additional Details
                  </label>
                  <textarea
                ...
                <div className="flex items-center bg-gray-800 p-3 rounded-lg border border-gray-600">
                  ...
                  <div className="flex-1">
                    <h3 className="text-white text-sm font-medium">Anonymous Submission</h3>
                    <p className="text-gray-400 text-xs">Your identity will be protected</p>
                  </div>
                  <input
                    name="isAnonymous"
                    type="checkbox"
          ...
          <div className="mt-6 p-4 bg-blue-900 bg-opacity-50 rounded-lg">
            <div className="flex items-start">
              ...
              <p className="text-sm text-gray-300">
                Your report helps law enforcement combat drug trafficking. All information is encrypted and handled securely.
              </p>
            </div>
          </div>
        )}
